const en = {
  ...
  "mk3_title": "Wyvern MK3 - 3-Inch FPV Quadcopter",
  "mk3_p1": "Third-generation Wyvern drone, a 3-inch FPV quadcopter. Mechanical design, hardware, firmware, RF communication, and embedded flight systems have all been iterated across previous generations, alongside testing of off-the-shelf solutions. MK3 brings together lessons from both approaches.",
  "mk3_p2": "Design references the MK2, with frame and structural components refined for reduced weight and a cleaner build. Carbon fiber frame; structural components (camera mount, antenna mount, battery mount) 3D-printed in TPU/ABS. Powered by 1303.5 5500 kV motors on 2-3S Li-ion or LiPo packs, tuned for a balance between speed and endurance. Equipped with DJI O4 Pro for digital FPV.",
  ...
  "norif411_p2": "Supports a range of RF link protocols for flexible integration: ELRS (ExpressLRS), TBS Crossfire, MAVLink, and my own custom RF protocol — allowing it to work across different ground stations and telemetry setups.",
  ...
  "uavcontroller_p1": "Full-stack quadcopter control system with ROS 2, ROS 2 simulation (Gazebo + RViz), and a custom communication protocol I built from scratch.",
  ...
  "uavcontroller_li5": "TX/RX stack: ESP32 (ESP-NOW) for indoor testing; outdoor comms use LoRa — ELRS, plus two custom stacks: one on 2.4 GHz and one on 433 MHz; CRSF/SBUS/PPM bridging; GPS support for autonomous navigation",
  ...
  "manualracer_title": "Wyvern MK1 — Racing Drone",
  "manualracer_p1": "3.5\" quadcopter with STM32F4/F7 flight controller, 3–6\" battery (typically 4S LiPo)—built for freestyle and racing, very fast.",
...
const zh = {
  ...
  "mk3_title": "Wyvern MK3 - 3寸FPV四旋翼",
  "mk3_p1": "第三代 Wyvern 无人机，一台3寸FPV四旋翼。机械设计、硬件、固件、射频通信及嵌入式飞控均在前代基础上迭代开发，同时也测试过市售方案。MK3 集成了两条路径的经验。",
  "mk3_p2": "设计参考 MK2，机架及结构件经过优化以降低重量、简化走线。碳纤维机架，结构件（摄像头座、天线座、电池座）采用TPU/ABS 3D打印。采用1303.5 5500 kV电机，支持2-3S锂离子或锂聚合物电池，在速度与续航之间取得平衡。配备 DJI O4 Pro 数字图传。",
  ...
  "norif411_p2": "支持ELRS、TBS Crossfire、MAVLink及自研RF协议，可适配不同地面站与遥测配置。",
  ...
  "uavcontroller_p1": "完整的无人机控制系统，基于ROS 2，配套Gazebo + RViz仿真环境，以及一套自研通信协议。",
  "uavcontroller_li1": "控制器（多种方案）：级联PID、LQR、MPC（ROS中采用C++，独立仿真采用Python）",
  "uavcontroller_li2": "ROS 2仿真流程：Gazebo + RViz，用于系统集成、可视化及控制器测试",
  "uavcontroller_li3": "路径规划（多种方案）：A*、RRT、RRT*，支持平地、林地、山地地形，全参数可调",
  "uavcontroller_li4": "安全机制：数据校验、限幅、看门狗",
  "uavcontroller_li5": "通信链路：室内采用ESP32（ESP-NOW），室外采用LoRa —— ELRS，以及两套自研链路（2.4 GHz与433 MHz）；支持CRSF/SBUS/PPM桥接；GPS支持自主导航",
  "uavcontroller_li6": "独立Python仿真器，无需ROS即可快速迭代：无人机姿态可视化、动力学仿真、可插拔的控制器/路径规划模块",
  "uavcontroller_gazebo_caption": "Gazebo仿真 —— RViz可视化与控制器测试",
  "uavcontroller_drone_caption": "用于测试自研通信链路的5寸无人机",
  ...
  "manualracer_title": "Wyvern MK1 — 竞速无人机",
  "manualracer_p1": "3.5英寸四旋翼，搭载STM32F4/F7飞控，支持3–6S电池（典型配置为4S LiPo），面向花式飞行与竞速场景。",
  "manualracer_p2": "机架采用Fusion 360拓扑优化（衍生式设计）完成，经过多材料、多几何版本迭代，每版均通过飞控黑匣子数据验证结构与飞行性能。最终版本采用碳纤维机架，自制安装件与集成。配备完整FPV系统及实时图传。",
  "7dof_title": "七自由度机械臂",
