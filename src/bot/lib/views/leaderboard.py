...
class raidView(_BaseView):
    ...
    async def button_tna(self, button: miru.Button, ctx: miru.Context):
    ...
    async def lb_display(self, ctx: miru.Context, page_num: int, raid_type: str):
    ...
    async def button_first_page(self, button: miru.Button, ctx: miru.Context):
        await self._change_page(ctx, "first")

    @miru.button(label="<", style=hikari.ButtonStyle.SECONDARY, row=3)
    async def button_prev_page(self, button: miru.Button, ctx: miru.Context):
    ...
    @miru.button(label=">>", style=hikari.ButtonStyle.SECONDARY, row=3)
    async def button_last_page(self, button: miru.Button, ctx: miru.Context):
        await self._change_page(ctx, "last")

    async def _change_page(self, ctx: miru.Context, action: str):
...
class GuildLeaderboardView(_BaseView):
    ...
    async def select_callback(self, select: miru.TextSelect, ctx: miru.Context):
    ...
    async def display_leaderboard(self, ctx: miru.Context):
...
class statView(_BaseView):
    ...
    async def button_pvp(self, button: miru.Button, ctx: miru.Context):
        await self._select_type(ctx, "PvP")

    @miru.button(label="Quest", style=hikari.ButtonStyle.SECONDARY, row=1)
    async def button_quests(self, button: miru.Button, ctx: miru.Context):
        await self._select_type(ctx, "Quests")

    @miru.button(label="Level", style=hikari.ButtonStyle.SECONDARY, row=1)
    async def button_levels(self, button: miru.Button, ctx: miru.Context):
        await self._select_type(ctx, "Levels")

    async def _select_type(self, ctx: miru.Context, stat_type: str):
    ...
    async def lb_display(self, ctx: miru.Context, page_num: int, stat_type: str):
