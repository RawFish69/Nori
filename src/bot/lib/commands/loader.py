...
from lib.commands.raid import load_raid_commands
...
from lib.commands.portal import load_portal_commands
...
from lib.commands.help import load_help_commands
...
def load_all_commands(bot: lightbulb.BotApp, blocked_users: list = None):
    ...
    load_help_commands(bot, blocked_users)
